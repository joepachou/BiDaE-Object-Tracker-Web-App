                ...
                <Modal.Body>
                    <Formik
                        initialValues = {{
                            ...
                            p_lbeacon: selectedData ? selectedData.perimeters.lbeacons : [],
                            f_lbeacon: selectedData ? selectedData.fences.lbeacons : [],
                            p_rssi: selectedData ? selectedData.perimeters.rssi : '',
                            f_rssi: selectedData ? selectedData.fences.rssi : '',
