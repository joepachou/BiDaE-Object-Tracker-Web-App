    ...
    L.AwesomeNumberMarkers = L.Icon.extend({
        ...
        _createInner: function() {
            ...
            if(options.numberColor) {
                iconColorStyle = "style='color: " + options.numberColor + "; font-size: " + options.numberSize + 'px' + "' ";          
            }
            return "<i " + iconColorStyle + "><strong className='font-weight-bold'>" + options.number + "</strong></i>";
        },
