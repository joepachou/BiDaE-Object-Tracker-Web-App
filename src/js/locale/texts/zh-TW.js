...
const tw = {
    ...
    SETTINGS: "設定",
    GENERAL_SETTINGS: "自定義設定",
    ASSET_USAGE: "資產使用資料紀錄",
    DEVICE_TRANSFER_RECORD: "產生儀器轉移紀錄",
    NOTES_ON_PATIENTS: "產生及檢視病人紀錄",
    GENERATE_AND_VIEW_SHIFT_CHANGE_RECORD: "產生及檢視交班報表",
    DEVICE_SERVICE_REQUEST: "要求儀器維修服務",
    OBJECT_TRACKING: "要求物件追蹤",
    SHIFT_CHANGE: "交班",
    ...
    MAC_ADDRESS_IS_REQUIRED: "請填入MAC位址",
    ...
    THE_MAC_ADDRESS_IS_ALREADY_USED_OR_FORMAT_IS_NOT_CORRECT: "MAC位址已被使用或格式錯誤",
    MAC_ADDRESS_FORMAT_IS_NOT_CORRECT: "MAC位址格式錯誤",
    ...
    /** placeholder */
    PLEASE_ENTER_OR_SCAN_MAC_ADDRESS: "請輸入或掃描MAC位址",
    PLEASE_ENTER_OR_SCAN_ASSET_CONTROL_NUMBER: "請輸入或掃描財產編號",
    TYPE_MAC_OR_NAME: "輸入MAC位址或是名字",
